...
const CourseCard = ({
  ...
  return (
    <Link
      ...
      className="flex flex-col justify-between border rounded-lg w-[300px] h-[340px] bg-white text-black shadow-lg transform transition-transform hover:scale-105 dark:bg-gray-800"
    >
      <img
